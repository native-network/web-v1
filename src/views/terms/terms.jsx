      ...
      <main className="container">
        ...
        <p class="c7">
          <span class="c4 c3">
            ...
            developing a platform for communities (&ldquo;Communities&rdquo;) to
            generate independent currencies backed by a liquid reserve, enabling
            them to organize local economies (the &ldquo;Native
            Ecosystem&rdquo;). &nbsp;The Native Ecosystem uses a reserve
            currency called &ldquo;Native Tokens&rdquo; that is staked into
            Communities to generate &ldquo;Community Tokens&rdquo; that
        ...
        <p class="c21">
          <span class="c4 c3">
            ...
            Tokens, and any mobile applications, websites, software, hardware,
            or other products and services developed or to be developed by
            Native (collectively, the &ldquo;Services&rdquo;). If you are using
            the Services on behalf of a business, you represent to us that you
            have authority to bind that business or entity to these Terms, and
        ...
        <p class="c21">
          <span class="c4 c3">
            ...
            Section 23), and affirm that you are of legal age to enter into this
            Agreement where you live and have the legal capacity to enter into
            this Agreement.
          </span>
        </p>
        <p class="c7">
        ...
        <p class="c0">
          ...
          <span class="c3">
            ...
            Communities. &nbsp;The Native Platform itself does not play an
            active role in the creation of Native Tokens; Native Tokens are only
        ...
        <p class="c0">
          <span class="c3">
            ...
            the Native Tokens into Community Tokens at a conversion rate
          ...
          <span class="c4 c3">
            ...
            in existence and the amount of Native Tokens in the Community
        ...
        <p class="c0">
          ...
          <span class="c4 c3">
            ...
            will have no role in Community decisions and management. All
            transactions involving Native and Community Tokens on the Native
        ...
        <p class="c0">
          ...
          <span class="c4 c3">
            ...
            Community&rsquo;s &ldquo;economy&rdquo; and may be used to pay for
            and reward efforts by Community members with respect to Community
            projects, to determine projects and goals to be pursued by a
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            to be explored, such as affinity membership of Community members
            with merchants and similar approaches to be determined by such
            Community. &nbsp;Community Tokens are also required (and will be
            added to a Community Development Pool when received) for proposing a
            project to a Community&rsquo;s curator, and marketing a project to a
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            operating funds (the &ldquo;Native Development Fund&rdquo;), and 50%
            is diverted to a reserve pool (the &ldquo;Native Reserve.&rdquo;)
            &nbsp;The Native Reserve has two primary purposes. &nbsp;First, it
            ensures liquidity for you or other users who wish to exchange their
            Native Tokens for Ether as they remove funds from the Native
            Platform. &nbsp;Second, it ensures that the price of Native Tokens
            (and, indirectly and partially, the prices of the various Community
            Tokens) remains tethered to the price of Bancor and that the prices
            of tokens used on the Native platform are intended to be relatively
            insulated from drastic price fluctuations. &nbsp;In sum, the value
            of the Native Reserve is substantially dependent on the market price
            of Bancor, a widely exchanged digital asset based on a decentralized
            protocol.{' '}
          </span>
        </p>
        <p class="c0">
          <span class="c4 c3">
            ...
            20% of the Community Tokens sent to the a reserve pool used to
            assist with liquidity and price stability (the &ldquo;Community
            Reserve&rdquo;). &nbsp;As with the Native Reserve, the conversion
            rate for Community Token creation or redemption is determined solely
            by the Bancor algorithm, which takes into account a number of
            factors, such as the number of Community Tokens outstanding and the
        ...
        <p class="c21">
          <span class="c4 c3">
            ...
            reserve the right to change the account type, suspend or terminate
            the Native Account of anyone who provides inaccurate, untrue, or
        ...
        <p class="c21">
          <span class="c4 c3">
            ...
            your wallet. Access to your wallet (and any Community Tokens or
            Native Tokens held in it) is available only with the access
            information and codes issued to you when establishing the wallet.
            When creating a Native Account, your wallet&rsquo;s encrypted
            password file is encrypted once more before is stored in a protected
            file, accessible only by your password. We do not see, track, save
            or have access to your password which can unlock the password
            protected file. When choosing a password for your wallet, remember
            that your wallet may be subject to hacking attempts, and wallets
            with strong passwords are less easily attacked. You can always
            access your wallet using your access information, even if at any
            time your access to the Services is be disabled for any reason
            whatsoever. You acknowledge and accept that you are solely
            responsible for the security of your wallet and for any use of your
            Native Account. Native will not be liable or accountable for any
            loss or damage regarding your failure to keep your Native Account or
            wallet access information secret and protected. Furthermore, Native
            has no control over your actions or transactions made using the
            Services.]
          </span>
        </p>
        <p class="c19">
        ...
        <p class="c21">
          <span class="c4 c3">
            ...
            a &ldquo;Revised Version&rdquo;). Each Revised Version will be
            effective as of the time it is posted, but will not apply
            retroactively. Your continued use of the Services after the posting
            of a Revised Version constitutes your acceptance of such Revised
            Version. Any Dispute (as defined in Section 22) that arose before
            the changes will be governed by these Terms in place when the
            Dispute arose.
          </span>
        </p>
        <p class="c7">
          <span class="c3">
            ...
            website, pushing notifications through the Services, or by emailing
            it to the email address listed in your Native Account. Electronic
            disclosures and notices have the same meaning and effect as if we
            had provided you with paper copies. Such disclosures and notices are
        ...
        <ol class="c10 lst-kix_list_2-0 start" start="1">
          ...
          <li class="c0 c5">
            <span class="c3">
              ...
              Crimes Enforcement Network (FinCEN), the Office of Foreign Assets
              Control (OFAC), countries listed by Transparency International
          ...
          <li class="c0 c5">
            <span class="c4 c3">
              ...
              technical limitations of the Services, use any tool to enable
              features or functionalities that are otherwise disabled in the
              Services, or decompile, disassemble or otherwise reverse engineer
              the Services;
            </span>
          </li>
          <li class="c0 c5">
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            illegal, or criminal purpose, you give us express authorization to
            share information about you, your Native Account, and any of your
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            your carrier. You may not use a modified device to use the Services
            if the modification is contrary to the manufacturer&rsquo;s software
            or hardware guidelines, including disabling hardware or software
            controls.
          </span>
        </p>
        <p class="c9">
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            services competitive with Native&rsquo;s or its partners&rsquo;
            products and services, as determined by us in our sole discretion;
            or (f) in our sole judgment, is objectionable, restricts or inhibits
            any person or entity from using or enjoying any portion of the
            Services, or which may expose Native, its affiliates or its
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            violations of Native&rsquo;s Terms. You understand that by using the
            Services, you may be exposed to material that is offensive,
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            improper purposes. You provide your personal information at your own
            risk.
          </span>
        </p>
        <p class="c0">
          <span class="c4 c3">
            ...
            unauthorized use of your password or Native Account or any other
            breach of security. Notwithstanding Sections 22 and 23, in the event
            of any dispute between two or more parties as to account ownership,
            we will be the sole arbiter of such dispute in our sole discretion.
            Our decision (which may include termination or suspension of any
            Native Account subject to dispute) will be final and binding on all
            parties.
          </span>
        </p>
        <p class="c0">
          <span class="c4 c3">
            ...
            existence or development of forked versions of Ethereum; flaws in
            the Solidity scripting language; disputes between Ethereum
            developers, miners and/or users; and regulatory action against
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            Account or update the contact information associated with your
            Native Account. Such communications may include, but are not limited
            ...
            and marketing or promotional communications. You acknowledge that
            you are not required to consent to receive promotional texts or
            calls as a condition of using the Services. Call and text message
            communications may be generated by automatic telephone dialing
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            that you would not like to receive future promotional calls. You may
            also opt-out of text messages from Native at any time by texting
            STOP to xxxxxx. You acknowledge that opting out of receiving
        ...
        <p class="c0 c8">
          <span class="c4 c3">
            ...
            discontinue or impose conditions on Services or any feature or
            aspect of a Service. We will take reasonable steps to notify you of
            termination or these other types of Service changes by email or at
            the next time you attempt to access your Native Account. You may
            also terminate these Terms and any additional terms applicable to
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            Termination), 14 (Ownership, Copyrights), 15 (Risks), 16
            (Indemnity), 17 (Representations and Warranties), 18 (No
            Warranties), 19 (Limitation of Liability and Damages), 20 (Third
            Party Products), 21 (Disputes), 22 (Binding Individual Arbitration),
            23 (Governing Law), 24 (Limitation on Time to Initiate a Dispute),
            25 (Assignment), 26 (Third Party Service and Links to Other Web
        ...
        <p class="c0 c8">
          <span class="c4 c3">
            ...
            continue using the Services. Any such software updates may be
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            below), in the Services and all copies of the Services. For the
            avoidance of doubt, these Terms do not grant to you any rights to
            the Services or our Intellectual Property Rights except as
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            and service mark rights, goodwill, trade secret rights, software,
            source code, concepts, text, artwork, photos, animations, sounds,
            methods of operation, documentation, virtual items, content and
            other intellectual property rights that may exist now or come into
            existence in the future, and all applications, registrations,
            renewals and extensions therefor and thereof, under the laws of any
        ...
        <ol class="c10 lst-kix_list_8-0" start="2">
          <li class="c7 c5">
            ...
            <span class="c4 c3">
              ...
              transaction is marked as complete or pending. Such conversion rate
              is determined by the Bancor algorithm and validated and recorded
              through the Ethereum blockchain. You understand that your public
              address will be made publicly visible whenever you use the
              Services.{' '}
            </span>
          </li>
        </ol>
        ...
        <ol class="c10 lst-kix_list_8-0" start="3">
          <li class="c7 c5">
            <span class="c4 c3">
              ...
              to tax or other regulations. You are solely responsible for
              reporting and paying any taxes arising from your use of the
              Services.{' '}
            </span>
          </li>
        </ol>
        ...
        <ol class="c10 lst-kix_list_8-0" start="4">
          <li class="c7 c5">
            <span class="c4 c3">
              ...
              difficulties, which may hinder the use of the Services or affect
              or even cause faults or failures in the conversion of fiat or
              cryptocurrency into Native Tokens or the redemption of Native
              Tokens. You agree not to hold Native accountable for any related
              losses.{' '}
            </span>
          </li>
        </ol>
        ...
        <ol class="c10 lst-kix_list_8-0" start="5">
          <li class="c7 c5">
            <span class="c4 c3">
              ...
              incidental to your relationship with us and imposes no obligation
              of truth or due diligence on behalf of Native or its
              representatives.{' '}
            </span>
          </li>
        </ol>
        ...
        <ol class="c10 lst-kix_list_8-0" start="6">
          <li class="c0 c5">
            ...
            <span class="c4 c3">
              ...
              protocol; and (b) that we are not responsible for operation of the
        ...
        <p class="c0 c8">
          <span class="c4 c3">
            ...
            attorneys&rsquo; fees) arising out of any claim, action, audit,
            ...
            set forth in these Terms; (b) your wrongful or improper use of the
            Services; (c) your violation of any third-party right, including
            ...
            other party&rsquo;s access and/or use of the Services with your
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            connection with the Services, including your business name,
            accurately and truthfully represents your business or personal
            identity under which you sell goods and services; (d) you and all
            transactions initiated by you will comply with all federal, state,
            and local laws, rules, and regulations applicable to you and/or your
            business; (e) you are not the subject or target of any economic or
            financial sanctions or trade embargoes, and your use of the Services
            will not cause Native to be in violation of any economic or
            financial sanctions or trade embargoes; (f) you acknowledge and
            understand that Native is not acting as an exchange, broker, dealer,
            fiduciary, investment manager, commodity pool operator, commodity
            trading advisor, or investment or financial adviser on your behalf;
            (g) you will not use the Services, directly or indirectly, for any
            fraudulent undertaking or in any manner so as to interfere with the
            operation of the Services; (h) your use of the Services will be in
            compliance with these Terms; and (i) you and any person using the
            Services on your behalf shall promptly notify Native if any of the
            above representations and warranties become inaccurate or
            incomplete.
          </span>
        </p>
        <p class="c9 c8">
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            USE, OR UNAVAILABILITY OF THE SERVICES. IN ALL CASES, NATIVE WILL
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            THE THREE (3) MONTH PERIOD IMMEDIATELY PRECEDING THE EVENT GIVING
        ...
        <p class="c0 c8">
          <span class="c4 c3">
            ...
            service and support for its product. For service, support, or
            warranty assistance, you should contact the manufacturer directly.
            NATIVE MAKES NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR IMPLIED,
            WITH RESPECT TO SUCH THIRD PARTY PRODUCTS, AND EXPRESSLY DISCLAIMS
            ANY WARRANTY OR CONDITION OF MERCHANTABILITY, NON-INFRINGEMENT, OR
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            employees), including any claims relating in any way to these Terms
        ...
        <p class="c7">
          <span class="c4 c3">
            ...
            TERMS WILL ONLY BE ON AN INDIVIDUAL BASIS; CLASS ARBITRATIONS, CLASS
            ACTIONS, REPRESENTATIVE ACTIONS, AND CONSOLIDATION WITH OTHER
            ARBITRATIONS ARE NOT PERMITTED. YOU WAIVE ANY RIGHT TO HAVE YOUR
            CASE DECIDED BY A JURY AND YOU WAIVE ANY RIGHT TO PARTICIPATE IN A
            CLASS ACTION AGAINST NATIVE. If any provision of this arbitration
            agreement is found unenforceable, the unenforceable provision will
            be severed, and the remaining arbitration terms will be enforced
            (but in no case will there be a class or representative
            arbitration). All Disputes will be resolved finally and exclusively
            by binding individual arbitration with a single arbitrator (the
            &ldquo;Arbitrator&rdquo;) administered by the American Arbitration
            Association&nbsp;(https://www.adr.org)&nbsp;according to this
            Section and the applicable arbitration rules for that forum. The
            Arbitrator shall be responsible for determining all threshold
            arbitrability issues, including issues relating to whether these
            Terms and/or additional terms (or any aspect thereof) are
            enforceable, unconscionable or illusory and any defense to
            arbitration, including waiver, delay, laches, or estoppel. Subject
            to applicable jurisdictional requirements, you may elect to pursue
            ...
            proceeds only on an individual (non-class or non-representative)
            basis. The Federal Arbitration Act, 9 U.S.C. &sect;&sect; 1-16,
            fully applies. If you are a consumer bringing a claim relating to a
            transaction intended for a personal, household, or family use, any
            arbitration hearing will occur within the county where you reside.
            Otherwise, any arbitration hearing will occur in New York, or
            another mutually agreeable location. The arbitrator&rsquo;s award
            will be binding on the parties and may be entered as a judgment in
            any court of competent jurisdiction. While an arbitrator may award
            declaratory or injunctive relief, the Arbitrator may do so only with
            respect to the individual party seeking relief and only to the
            extent necessary to provide relief warranted by the individual
            party&rsquo;s claim. An Arbitrator&rsquo;s decision and judgment
            thereon will not have a precedential or collateral estoppel effect.
            Native will reimburse the arbitration fees due to the American
            Arbitration Association for individual arbitrations brought in
            accordance with this section for all claims totaling less than
            $10,000 unless the Arbitrator determines that your claims were
            frivolous. If you prevail on any claim for which you are legally
            entitled to attorney&rsquo;s fees, you may seek to recover those
            fees from the arbitrator. For any claim where you are seeking
            relief, we will not seek to have you pay our attorney&rsquo;s fees,
            even if fees might otherwise be awarded, unless the Arbitrator
            ...
            beneficiaries of the Services. Subject to and without waiver of the
            arbitration provisions above, you agree that any judicial
            proceedings (other than small claims actions in consumer cases as
            discussed above) will be brought in and you hereby consent to the
            exclusive jurisdiction and venue of the New York state courts, or
        ...
        <p class="c0">
          <span class="c3">
            ...
            Party Services&rdquo;). If you decide to use Third Party Services,
            you will be responsible for reviewing and understanding the terms
            and conditions for these services. We are not responsible or liable
            for the performance of any Third Party Services. Further, you agree
            to resolve any disagreement between you and a third party regarding
            the terms and conditions of any Third Party Services with that third
          ...
          <span class="c4 c3">
            ...
            are not governed by these Terms. You access any such website at your
            own risk. We expressly disclaim any liability for these websites.
            When you use a link to go from the Services to a third party
            website, our Privacy Notice is no longer in effect. Your browsing
            and interaction on a third party website, including those that have
            a link in the Services is subject to that website&rsquo;s own terms,
            rules and policies.
          </span>
        </p>
        <p class="c9">
        ...
        <p class="c0">
          <span class="c4 c3">
            ...
            calculate, collect, report, or remit any Taxes to any tax authority
            arising from any transaction. Native specifically disclaims any
            liability for Taxes.{' '}
          </span>
        </p>
        <p class="c9">
        ...
        <p class="c7">
          <span class="c4 c3">
            ...
            other Native agreement or policy, these Terms will prevail and
            control the subject matter of such conflict. If any provision of
            these Terms or any additional term is invalid or unenforceable under
            applicable law, then it will be changed and interpreted to
            accomplish the objectives of such provision to the greatest extent
            possible under applicable law, and the remaining provisions will
            continue in full force and effect. These terms do not limit any
            rights that we may have under trade secret, copyright, patent, or
            other laws. No waiver of any term of these Terms will be deemed a
