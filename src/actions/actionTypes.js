...
export const communityTasksActions = {
  ...
  ADD_NEW_CONTRACT_TASK: 'ADD_NEW_CONTRACT_TASK',
  ADD_NEW_CONTRACT_TASK_SUCCESS: 'ADD_NEW_CONTRACT_TASK_SUCCESS',
  ADD_NEW_CONTRACT_TASK_ERROR: 'ADD_NEW_CONTRACT_TASK_ERROR',
};
