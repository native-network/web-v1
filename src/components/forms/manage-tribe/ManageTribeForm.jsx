...
import styles from './ManageTribeForm.css';

import Button from '../../shared/button';
import FilePicker from '../../shared/file-picker/FilePicker';

export default function ManageTribeForm({submitForm}) {
  // Render Error
  ...
  return (
    <Form
      ...
      render={({handleSubmit, pristine, invalid, values}) => (
        <form className={styles.ManageTribeForm} onSubmit={handleSubmit}>
          <div className={styles.ManageTribeFields}>
            <Field name="name" validate={validateName}>
              {({input, meta}) => (
                <div className={styles.FieldGroup}>
                  <label>Tribe Name</label>
                  <input {...input} type="text" placeholder="Tribe name" />
            ...
            <Field name="tribePurpose" validate={charLength}>
              {({input, meta}) => (
                <div className={styles.FieldGroup}>
                  <label>About</label>
                  <textarea
            ...
            <Field name="tribeIntro" validate={charLength}>
              {({input, meta}) => (
                <div className={styles.FieldGroup}>
            ...
            {/* <Field name="tribeImage" component={FilePicker} type="file" /> */}
          </div>
          <code>
